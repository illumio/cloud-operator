...
func (Port_Protocol) EnumDescriptor() ([]byte, []int) {
	return file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_rawDescGZIP(), []int{25, 0}
}
...
type KubernetesObjectData struct {
	...
	//	*KubernetesObjectData_AwsSecurityGroupPolicy
...
func (x *KubernetesObjectData) GetAwsSecurityGroupPolicy() *KubernetesAWSSecurityGroupPolicyData {
	if x != nil {
		if x, ok := x.KindSpecific.(*KubernetesObjectData_AwsSecurityGroupPolicy); ok {
			return x.AwsSecurityGroupPolicy
		}
	}
	return nil
}
...
type KubernetesObjectData_AwsClusterNetworkPolicy struct {
	AwsClusterNetworkPolicy *KubernetesAWSClusterNetworkPolicyData `protobuf:"bytes,106,opt,name=aws_cluster_network_policy,json=awsClusterNetworkPolicy,proto3,oneof"`
}

type KubernetesObjectData_AwsSecurityGroupPolicy struct {
	AwsSecurityGroupPolicy *KubernetesAWSSecurityGroupPolicyData `protobuf:"bytes,107,opt,name=aws_security_group_policy,json=awsSecurityGroupPolicy,proto3,oneof"`
}
...
func (*KubernetesObjectData_AwsSecurityGroupPolicy) isKubernetesObjectData_KindSpecific() {}
...
type KubernetesCiliumNetworkPolicyData struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Endpoint selector selects the pods to which this policy applies.
	// Uses Cilium's endpoint selector which supports label-based and identity-based selection.
	...
	// Ingress rules define allowed/denied incoming traffic.
	IngressRules []*CiliumNetworkPolicyRule `protobuf:"bytes,2,rep,name=ingress_rules,json=ingressRules,proto3" json:"ingress_rules,omitempty"`
	// Egress rules define allowed/denied outgoing traffic.
	EgressRules []*CiliumNetworkPolicyRule `protobuf:"bytes,3,rep,name=egress_rules,json=egressRules,proto3" json:"egress_rules,omitempty"`
	// IngressDeny rules explicitly deny incoming traffic.
	IngressDenyRules []*CiliumNetworkPolicyRule `protobuf:"bytes,4,rep,name=ingress_deny_rules,json=ingressDenyRules,proto3" json:"ingress_deny_rules,omitempty"`
	// EgressDeny rules explicitly deny outgoing traffic.
	EgressDenyRules []*CiliumNetworkPolicyRule `protobuf:"bytes,5,rep,name=egress_deny_rules,json=egressDenyRules,proto3" json:"egress_deny_rules,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *KubernetesCiliumNetworkPolicyData) GetEndpointSelector() *LabelSelector {
	if x != nil {
...
func (x *KubernetesCiliumNetworkPolicyData) GetIngressRules() []*CiliumNetworkPolicyRule {
	if x != nil {
		return x.IngressRules
	}
	return nil
...
func (x *KubernetesCiliumNetworkPolicyData) GetEgressRules() []*CiliumNetworkPolicyRule {
	if x != nil {
		return x.EgressRules
	}
	return nil
...
func (x *KubernetesCiliumNetworkPolicyData) GetIngressDenyRules() []*CiliumNetworkPolicyRule {
	if x != nil {
...
func (x *KubernetesCiliumNetworkPolicyData) GetEgressDenyRules() []*CiliumNetworkPolicyRule {
	if x != nil {
...
type KubernetesCiliumClusterwideNetworkPolicyData struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Endpoint selector selects the pods to which this policy applies cluster-wide.
	EndpointSelector *LabelSelector `protobuf:"bytes,1,opt,name=endpoint_selector,json=endpointSelector,proto3" json:"endpoint_selector,omitempty"`
	// Node selector selects the nodes to which this policy applies (for host policies).
	...
	// Ingress rules define allowed/denied incoming traffic.
	IngressRules []*CiliumNetworkPolicyRule `protobuf:"bytes,3,rep,name=ingress_rules,json=ingressRules,proto3" json:"ingress_rules,omitempty"`
	// Egress rules define allowed/denied outgoing traffic.
	EgressRules []*CiliumNetworkPolicyRule `protobuf:"bytes,4,rep,name=egress_rules,json=egressRules,proto3" json:"egress_rules,omitempty"`
	// IngressDeny rules explicitly deny incoming traffic.
	IngressDenyRules []*CiliumNetworkPolicyRule `protobuf:"bytes,5,rep,name=ingress_deny_rules,json=ingressDenyRules,proto3" json:"ingress_deny_rules,omitempty"`
	// EgressDeny rules explicitly deny outgoing traffic.
	EgressDenyRules []*CiliumNetworkPolicyRule `protobuf:"bytes,6,rep,name=egress_deny_rules,json=egressDenyRules,proto3" json:"egress_deny_rules,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *KubernetesCiliumClusterwideNetworkPolicyData) GetEndpointSelector() *LabelSelector {
	if x != nil {
		return x.EndpointSelector
	}
	return nil
...
func (x *KubernetesCiliumClusterwideNetworkPolicyData) GetNodeSelector() *LabelSelector {
	if x != nil {
...
func (x *KubernetesCiliumClusterwideNetworkPolicyData) GetIngressRules() []*CiliumNetworkPolicyRule {
	if x != nil {
		return x.IngressRules
	}
	return nil
...
func (x *KubernetesCiliumClusterwideNetworkPolicyData) GetEgressRules() []*CiliumNetworkPolicyRule {
	if x != nil {
		return x.EgressRules
	}
	return nil
...
func (x *KubernetesCiliumClusterwideNetworkPolicyData) GetIngressDenyRules() []*CiliumNetworkPolicyRule {
	if x != nil {
		return x.IngressDenyRules
	}
	return nil
...
func (x *KubernetesCiliumClusterwideNetworkPolicyData) GetEgressDenyRules() []*CiliumNetworkPolicyRule {
	if x != nil {
		return x.EgressDenyRules
	}
	return nil
...
// CiliumNetworkPolicyRule defines a single Cilium ingress or egress rule.
// Cilium rules support richer selectors including identity-based and CIDR-based selection.
type CiliumNetworkPolicyRule struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// FromEndpoints selects source endpoints by labels (for ingress rules).
	...
	// ToEndpoints selects destination endpoints by labels (for egress rules).
	ToEndpoints []*LabelSelector `protobuf:"bytes,2,rep,name=to_endpoints,json=toEndpoints,proto3" json:"to_endpoints,omitempty"`
	// FromCIDR allows traffic from specific CIDR ranges.
	FromCidr []string `protobuf:"bytes,3,rep,name=from_cidr,json=fromCidr,proto3" json:"from_cidr,omitempty"`
	// ToCIDR allows traffic to specific CIDR ranges.
	ToCidr []string `protobuf:"bytes,4,rep,name=to_cidr,json=toCidr,proto3" json:"to_cidr,omitempty"`
	// FromCIDRSet allows traffic from CIDR ranges with exceptions.
	FromCidrSet []*CiliumCIDRSet `protobuf:"bytes,5,rep,name=from_cidr_set,json=fromCidrSet,proto3" json:"from_cidr_set,omitempty"`
	// ToCIDRSet allows traffic to CIDR ranges with exceptions.
	ToCidrSet []*CiliumCIDRSet `protobuf:"bytes,6,rep,name=to_cidr_set,json=toCidrSet,proto3" json:"to_cidr_set,omitempty"`
	// ToPorts specifies the allowed destination ports and protocols.
	ToPorts []*CiliumPortRule `protobuf:"bytes,7,rep,name=to_ports,json=toPorts,proto3" json:"to_ports,omitempty"`
	// FromEntities allows traffic from Cilium-defined entities (e.g., "world", "cluster", "host").
	FromEntities []string `protobuf:"bytes,8,rep,name=from_entities,json=fromEntities,proto3" json:"from_entities,omitempty"`
	// ToEntities allows traffic to Cilium-defined entities.
	ToEntities    []string `protobuf:"bytes,9,rep,name=to_entities,json=toEntities,proto3" json:"to_entities,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CiliumNetworkPolicyRule) Reset() {
	*x = CiliumNetworkPolicyRule{}
	mi := &file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CiliumNetworkPolicyRule) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CiliumNetworkPolicyRule) ProtoMessage() {}

func (x *CiliumNetworkPolicyRule) ProtoReflect() protoreflect.Message {
	mi := &file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CiliumNetworkPolicyRule.ProtoReflect.Descriptor instead.
func (*CiliumNetworkPolicyRule) Descriptor() ([]byte, []int) {
	return file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_rawDescGZIP(), []int{8}
}

func (x *CiliumNetworkPolicyRule) GetFromEndpoints() []*LabelSelector {
	if x != nil {
...
func (x *CiliumNetworkPolicyRule) GetToEndpoints() []*LabelSelector {
	if x != nil {
...
func (x *CiliumNetworkPolicyRule) GetFromCidr() []string {
	if x != nil {
		return x.FromCidr
	}
	return nil
...
func (x *CiliumNetworkPolicyRule) GetToCidr() []string {
	if x != nil {
		return x.ToCidr
	}
	return nil
...
func (x *CiliumNetworkPolicyRule) GetFromCidrSet() []*CiliumCIDRSet {
	if x != nil {
...
func (x *CiliumNetworkPolicyRule) GetToCidrSet() []*CiliumCIDRSet {
	if x != nil {
		return x.ToCidrSet
	}
	return nil
...
func (x *CiliumNetworkPolicyRule) GetToPorts() []*CiliumPortRule {
	if x != nil {
		return x.ToPorts
	}
	return nil
...
func (x *CiliumNetworkPolicyRule) GetFromEntities() []string {
	if x != nil {
...
func (x *CiliumNetworkPolicyRule) GetToEntities() []string {
	if x != nil {
		return x.ToEntities
	}
	return nil
...
// CiliumPort defines a single port with protocol.
type CiliumPort struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Port          string                 `protobuf:"bytes,1,opt,name=port,proto3" json:"port,omitempty"`         // Port number or name
	Protocol      string                 `protobuf:"bytes,2,opt,name=protocol,proto3" json:"protocol,omitempty"` // TCP, UDP, SCTP, or ANY
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CiliumPort) GetProtocol() string {
	if x != nil {
		return x.Protocol
	}
	return ""
...
// KubernetesAWSClusterNetworkPolicyData contains information specific to an AWS VPC CNI ClusterNetworkPolicy.
// ClusterNetworkPolicy is a cluster-scoped network policy for AWS EKS clusters using the VPC CNI.
// API: networking.k8s.aws/v1alpha1
type KubernetesAWSClusterNetworkPolicyData struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Priority determines the order in which policies are evaluated (lower = higher priority).
	Priority int32 `protobuf:"varint,1,opt,name=priority,proto3" json:"priority,omitempty"`
	// Tier categorizes the policy (e.g., "Admin", "Application").
	...
	// Ingress rules define allowed/denied incoming traffic.
	IngressRules []*AWSNetworkPolicyRule `protobuf:"bytes,4,rep,name=ingress_rules,json=ingressRules,proto3" json:"ingress_rules,omitempty"`
	// Egress rules define allowed/denied outgoing traffic.
	EgressRules   []*AWSNetworkPolicyRule `protobuf:"bytes,5,rep,name=egress_rules,json=egressRules,proto3" json:"egress_rules,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *KubernetesAWSClusterNetworkPolicyData) GetIngressRules() []*AWSNetworkPolicyRule {
	if x != nil {
		return x.IngressRules
	}
	return nil
...
func (x *KubernetesAWSClusterNetworkPolicyData) GetEgressRules() []*AWSNetworkPolicyRule {
	if x != nil {
		return x.EgressRules
	}
	return nil
...
// KubernetesAWSSecurityGroupPolicyData contains information specific to an AWS SecurityGroupPolicy.
// SecurityGroupPolicy associates pods with AWS Security Groups.
// API: vpcresources.k8s.aws/v1beta1
type KubernetesAWSSecurityGroupPolicyData struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	// ServiceAccountSelector selects pods by service account (alternative to podSelector).
	ServiceAccountSelector *LabelSelector `protobuf:"bytes,2,opt,name=service_account_selector,json=serviceAccountSelector,proto3,oneof" json:"service_account_selector,omitempty"`
	// SecurityGroupIds lists the AWS Security Group IDs to associate with selected pods.
...
func (x *KubernetesAWSSecurityGroupPolicyData) Reset() {
	*x = KubernetesAWSSecurityGroupPolicyData{}
	mi := &file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *KubernetesAWSSecurityGroupPolicyData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KubernetesAWSSecurityGroupPolicyData) ProtoMessage() {}

func (x *KubernetesAWSSecurityGroupPolicyData) ProtoReflect() protoreflect.Message {
	mi := &file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KubernetesAWSSecurityGroupPolicyData.ProtoReflect.Descriptor instead.
func (*KubernetesAWSSecurityGroupPolicyData) Descriptor() ([]byte, []int) {
	return file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_rawDescGZIP(), []int{13}
}

func (x *KubernetesAWSSecurityGroupPolicyData) GetPodSelector() *LabelSelector {
	if x != nil {
		return x.PodSelector
	}
	return nil
...
func (x *KubernetesAWSSecurityGroupPolicyData) GetServiceAccountSelector() *LabelSelector {
	if x != nil {
...
func (x *KubernetesAWSSecurityGroupPolicyData) GetSecurityGroupIds() []string {
	if x != nil {
...
// AWSNetworkPolicySubject defines which pods a ClusterNetworkPolicy applies to.
// The subject can be either pods (with namespace and pod selectors) or namespaces.
type AWSNetworkPolicySubject struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Pods selector with namespace and pod label selectors.
	Pods *AWSNetworkPolicyPodSelector `protobuf:"bytes,1,opt,name=pods,proto3,oneof" json:"pods,omitempty"`
	// Namespaces selector - selects all pods in matching namespaces.
	Namespaces    *LabelSelector `protobuf:"bytes,2,opt,name=namespaces,proto3,oneof" json:"namespaces,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// AWSNetworkPolicyPodSelector selects pods by namespace and pod labels.
type AWSNetworkPolicyPodSelector struct {
	...
	// PodSelector selects pods within the selected namespaces.
...
// AWSNetworkPolicyRule defines an ingress or egress rule for AWS ClusterNetworkPolicy.
type AWSNetworkPolicyRule struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Action specifies whether to allow or deny traffic ("Accept" or "Deny").
	Action string `protobuf:"bytes,1,opt,name=action,proto3" json:"action,omitempty"`
	// Ports specifies the allowed/denied ports.
	Ports []*AWSNetworkPolicyPort `protobuf:"bytes,2,rep,name=ports,proto3" json:"ports,omitempty"`
	// From specifies the traffic sources (for ingress rules).
	From []*AWSNetworkPolicyPeer `protobuf:"bytes,3,rep,name=from,proto3" json:"from,omitempty"`
	// To specifies the traffic destinations (for egress rules).
	To            []*AWSNetworkPolicyPeer `protobuf:"bytes,4,rep,name=to,proto3" json:"to,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AWSNetworkPolicyRule) Reset() {
	*x = AWSNetworkPolicyRule{}
	mi := &file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AWSNetworkPolicyRule) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AWSNetworkPolicyRule) ProtoMessage() {}

func (x *AWSNetworkPolicyRule) ProtoReflect() protoreflect.Message {
	mi := &file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AWSNetworkPolicyRule.ProtoReflect.Descriptor instead.
func (*AWSNetworkPolicyRule) Descriptor() ([]byte, []int) {
	return file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_rawDescGZIP(), []int{16}
}

func (x *AWSNetworkPolicyRule) GetAction() string {
	if x != nil {
		return x.Action
	}
	return ""
...
func (x *AWSNetworkPolicyRule) GetPorts() []*AWSNetworkPolicyPort {
	if x != nil {
		return x.Ports
	}
	return nil
...
func (x *AWSNetworkPolicyRule) GetFrom() []*AWSNetworkPolicyPeer {
	if x != nil {
		return x.From
	}
	return nil
...
func (x *AWSNetworkPolicyRule) GetTo() []*AWSNetworkPolicyPeer {
	if x != nil {
		return x.To
	}
	return nil
...
// AWSNetworkPolicyPort defines a port specification for AWS network policies.
type AWSNetworkPolicyPort struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// PortNumber specifies a numeric port.
	PortNumber    *AWSPortNumber `protobuf:"bytes,1,opt,name=port_number,json=portNumber,proto3,oneof" json:"port_number,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// AWSPortNumber defines a port number with protocol.
...
// AWSNetworkPolicyPeer defines a network peer for AWS network policies.
type AWSNetworkPolicyPeer struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Networks specifies CIDR ranges.
	Networks []string `protobuf:"bytes,1,rep,name=networks,proto3" json:"networks,omitempty"`
	// Pods selector for pod-based peers.
	Pods *AWSNetworkPolicyPodSelector `protobuf:"bytes,2,opt,name=pods,proto3,oneof" json:"pods,omitempty"`
	// Namespaces selector for namespace-based peers.
	Namespaces *LabelSelector `protobuf:"bytes,3,opt,name=namespaces,proto3,oneof" json:"namespaces,omitempty"`
	// DomainNames specifies FQDNs for egress rules (Accept action only, EKS Auto Mode).
	// Supports wildcards like "*.google.com".
	DomainNames   []string `protobuf:"bytes,4,rep,name=domain_names,json=domainNames,proto3" json:"domain_names,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AWSNetworkPolicyPeer) Reset() {
	*x = AWSNetworkPolicyPeer{}
	mi := &file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AWSNetworkPolicyPeer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AWSNetworkPolicyPeer) ProtoMessage() {}

func (x *AWSNetworkPolicyPeer) ProtoReflect() protoreflect.Message {
	mi := &file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AWSNetworkPolicyPeer.ProtoReflect.Descriptor instead.
func (*AWSNetworkPolicyPeer) Descriptor() ([]byte, []int) {
	return file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_rawDescGZIP(), []int{19}
}

func (x *AWSNetworkPolicyPeer) GetNetworks() []string {
	if x != nil {
		return x.Networks
	}
	return nil
...
func (x *AWSNetworkPolicyPeer) GetPods() *AWSNetworkPolicyPodSelector {
	if x != nil {
		return x.Pods
	}
	return nil
...
func (x *AWSNetworkPolicyPeer) GetNamespaces() *LabelSelector {
	if x != nil {
		return x.Namespaces
	}
	return nil
...
func (x *AWSNetworkPolicyPeer) GetDomainNames() []string {
	if x != nil {
...
func (*GetConfigurationUpdatesResponse_Configuration) Descriptor() ([]byte, []int) {
	return file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_rawDescGZIP(), []int{53, 0}
}
...
const file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_rawDesc = "" +
	...
	"!cilium_clusterwide_network_policy\x18i \x01(\v2M.illumio.cloud.k8sclustersync.v1.KubernetesCiliumClusterwideNetworkPolicyDataH\x00R\x1eciliumClusterwideNetworkPolicy\x12\x85\x01\n" +
	"\x1aaws_cluster_network_policy\x18j \x01(\v2F.illumio.cloud.k8sclustersync.v1.KubernetesAWSClusterNetworkPolicyDataH\x00R\x17awsClusterNetworkPolicy\x12\x82\x01\n" +
	"\x19aws_security_group_policy\x18k \x01(\v2E.illumio.cloud.k8sclustersync.v1.KubernetesAWSSecurityGroupPolicyDataH\x00R\x16awsSecurityGroupPolicy\x1a>\n" +
	...
	"\bprotocol\x18\x02 \x01(\tR\bprotocol\"\xe1\x02\n" +
	...
	"\asubject\x18\x03 \x01(\v28.illumio.cloud.k8sclustersync.v1.AWSNetworkPolicySubjectR\asubject\x12Z\n" +
	"\ringress_rules\x18\x04 \x03(\v25.illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyRuleR\fingressRules\x12X\n" +
	"\fegress_rules\x18\x05 \x03(\v25.illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyRuleR\vegressRules\"\xb3\x02\n" +
	"$KubernetesAWSSecurityGroupPolicyData\x12Q\n" +
	"\fpod_selector\x18\x01 \x01(\v2..illumio.cloud.k8sclustersync.v1.LabelSelectorR\vpodSelector\x12m\n" +
	"\x18service_account_selector\x18\x02 \x01(\v2..illumio.cloud.k8sclustersync.v1.LabelSelectorH\x00R\x16serviceAccountSelector\x88\x01\x01\x12,\n" +
	"\x12security_group_ids\x18\x03 \x03(\tR\x10securityGroupIdsB\x1b\n" +
	"\x19_service_account_selector\"\xdd\x01\n" +
	"\x17AWSNetworkPolicySubject\x12U\n" +
	"\x04pods\x18\x01 \x01(\v2<.illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPodSelectorH\x00R\x04pods\x88\x01\x01\x12S\n" +
	"\n" +
	"namespaces\x18\x02 \x01(\v2..illumio.cloud.k8sclustersync.v1.LabelSelectorH\x01R\n" +
	"namespaces\x88\x01\x01B\a\n" +
	"\x05_podsB\r\n" +
	"\v_namespaces\"\xcf\x01\n" +
	...
	"\fpod_selector\x18\x02 \x01(\v2..illumio.cloud.k8sclustersync.v1.LabelSelectorR\vpodSelector\"\x8d\x02\n" +
	"\x14AWSNetworkPolicyRule\x12\x16\n" +
	"\x06action\x18\x01 \x01(\tR\x06action\x12K\n" +
	"\x05ports\x18\x02 \x03(\v25.illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPortR\x05ports\x12I\n" +
	"\x04from\x18\x03 \x03(\v25.illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPeerR\x04from\x12E\n" +
	"\x02to\x18\x04 \x03(\v25.illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPeerR\x02to\"|\n" +
	"\x14AWSNetworkPolicyPort\x12T\n" +
	"\vport_number\x18\x01 \x01(\v2..illumio.cloud.k8sclustersync.v1.AWSPortNumberH\x00R\n" +
	"portNumber\x88\x01\x01B\x0e\n" +
	"\f_port_number\"?\n" +
	"\rAWSPortNumber\x12\x12\n" +
	"\x04port\x18\x01 \x01(\x05R\x04port\x12\x1a\n" +
	"\bprotocol\x18\x02 \x01(\tR\bprotocol\"\x99\x02\n" +
	"\x14AWSNetworkPolicyPeer\x12\x1a\n" +
	"\bnetworks\x18\x01 \x03(\tR\bnetworks\x12U\n" +
	"\x04pods\x18\x02 \x01(\v2<.illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPodSelectorH\x00R\x04pods\x88\x01\x01\x12S\n" +
	"\n" +
	"namespaces\x18\x03 \x01(\v2..illumio.cloud.k8sclustersync.v1.LabelSelectorH\x01R\n" +
	"namespaces\x88\x01\x01\x12!\n" +
	"\fdomain_names\x18\x04 \x03(\tR\vdomainNamesB\a\n" +
	"\x05_podsB\r\n" +
	"\v_namespaces\"\x9b\x02\n" +
	"\rLabelSelector\x12b\n" +
...
var file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_msgTypes = make([]protoimpl.MessageInfo, 59)
var file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_goTypes = []any{
	...
	(*CiliumNetworkPolicyRule)(nil),                      // 14: illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	(*CiliumCIDRSet)(nil),                                // 15: illumio.cloud.k8sclustersync.v1.CiliumCIDRSet
	(*CiliumPortRule)(nil),                               // 16: illumio.cloud.k8sclustersync.v1.CiliumPortRule
	(*CiliumPort)(nil),                                   // 17: illumio.cloud.k8sclustersync.v1.CiliumPort
	(*KubernetesAWSClusterNetworkPolicyData)(nil),        // 18: illumio.cloud.k8sclustersync.v1.KubernetesAWSClusterNetworkPolicyData
	(*KubernetesAWSSecurityGroupPolicyData)(nil),         // 19: illumio.cloud.k8sclustersync.v1.KubernetesAWSSecurityGroupPolicyData
	(*AWSNetworkPolicySubject)(nil),                      // 20: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicySubject
	(*AWSNetworkPolicyPodSelector)(nil),                  // 21: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPodSelector
	(*AWSNetworkPolicyRule)(nil),                         // 22: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyRule
	(*AWSNetworkPolicyPort)(nil),                         // 23: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPort
	(*AWSPortNumber)(nil),                                // 24: illumio.cloud.k8sclustersync.v1.AWSPortNumber
	(*AWSNetworkPolicyPeer)(nil),                         // 25: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPeer
	(*LabelSelector)(nil),                                // 26: illumio.cloud.k8sclustersync.v1.LabelSelector
	(*LabelSelectorRequirement)(nil),                     // 27: illumio.cloud.k8sclustersync.v1.LabelSelectorRequirement
	(*IPBlock)(nil),                                      // 28: illumio.cloud.k8sclustersync.v1.IPBlock
	(*Peer)(nil),                                         // 29: illumio.cloud.k8sclustersync.v1.Peer
	(*PeerSelector)(nil),                                 // 30: illumio.cloud.k8sclustersync.v1.PeerSelector
	(*Port)(nil),                                         // 31: illumio.cloud.k8sclustersync.v1.Port
	(*NetworkPolicyRule)(nil),                            // 32: illumio.cloud.k8sclustersync.v1.NetworkPolicyRule
	(*KubernetesOwnerReference)(nil),                     // 33: illumio.cloud.k8sclustersync.v1.KubernetesOwnerReference
	(*KubernetesClusterMetadata)(nil),                    // 34: illumio.cloud.k8sclustersync.v1.KubernetesClusterMetadata
	(*SendKubernetesResourcesRequest)(nil),               // 35: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest
	(*KubernetesResourceSnapshotComplete)(nil),           // 36: illumio.cloud.k8sclustersync.v1.KubernetesResourceSnapshotComplete
	(*SendKubernetesResourcesResponse)(nil),              // 37: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesResponse
	(*KubernetesResourceMutation)(nil),                   // 38: illumio.cloud.k8sclustersync.v1.KubernetesResourceMutation
	(*FiveTupleFlow)(nil),                                // 39: illumio.cloud.k8sclustersync.v1.FiveTupleFlow
	(*CiliumFlow)(nil),                                   // 40: illumio.cloud.k8sclustersync.v1.CiliumFlow
	(*Service)(nil),                                      // 41: illumio.cloud.k8sclustersync.v1.Service
	(*IP)(nil),                                           // 42: illumio.cloud.k8sclustersync.v1.IP
	(*Layer4)(nil),                                       // 43: illumio.cloud.k8sclustersync.v1.Layer4
	(*TCP)(nil),                                          // 44: illumio.cloud.k8sclustersync.v1.TCP
	(*TCPFlags)(nil),                                     // 45: illumio.cloud.k8sclustersync.v1.TCPFlags
	(*UDP)(nil),                                          // 46: illumio.cloud.k8sclustersync.v1.UDP
	(*SCTP)(nil),                                         // 47: illumio.cloud.k8sclustersync.v1.SCTP
	(*ICMPv4)(nil),                                       // 48: illumio.cloud.k8sclustersync.v1.ICMPv4
	(*ICMPv6)(nil),                                       // 49: illumio.cloud.k8sclustersync.v1.ICMPv6
	(*Endpoint)(nil),                                     // 50: illumio.cloud.k8sclustersync.v1.Endpoint
	(*Workload)(nil),                                     // 51: illumio.cloud.k8sclustersync.v1.Workload
	(*Policy)(nil),                                       // 52: illumio.cloud.k8sclustersync.v1.Policy
	(*SendKubernetesNetworkFlowsRequest)(nil),            // 53: illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsRequest
	(*SendKubernetesNetworkFlowsResponse)(nil),           // 54: illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsResponse
	(*LogEntry)(nil),                                     // 55: illumio.cloud.k8sclustersync.v1.LogEntry
	(*SendLogsRequest)(nil),                              // 56: illumio.cloud.k8sclustersync.v1.SendLogsRequest
	(*SendLogsResponse)(nil),                             // 57: illumio.cloud.k8sclustersync.v1.SendLogsResponse
	(*GetConfigurationUpdatesRequest)(nil),               // 58: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesRequest
	(*GetConfigurationUpdatesResponse)(nil),              // 59: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse
	nil,                                                  // 60: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.AnnotationsEntry
	nil,                                                  // 61: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.LabelsEntry
	(*KubernetesServiceData_ServicePort)(nil),            // 62: illumio.cloud.k8sclustersync.v1.KubernetesServiceData.ServicePort
	nil, // 63: illumio.cloud.k8sclustersync.v1.LabelSelector.MatchLabelsEntry
	(*GetConfigurationUpdatesResponse_Configuration)(nil), // 64: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse.Configuration
...
var file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_depIdxs = []int32{
	60,  // 0: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.annotations:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData.AnnotationsEntry
	65,  // 1: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.creation_timestamp:type_name -> google.protobuf.Timestamp
	61,  // 2: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.labels:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData.LabelsEntry
	33,  // 3: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.owner_references:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesOwnerReference
	...
	18,  // 10: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.aws_cluster_network_policy:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesAWSClusterNetworkPolicyData
	19,  // 11: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.aws_security_group_policy:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesAWSSecurityGroupPolicyData
	62,  // 12: illumio.cloud.k8sclustersync.v1.KubernetesServiceData.ports:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesServiceData.ServicePort
	26,  // 13: illumio.cloud.k8sclustersync.v1.KubernetesNetworkPolicyData.pod_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	32,  // 14: illumio.cloud.k8sclustersync.v1.KubernetesNetworkPolicyData.ingress_rules:type_name -> illumio.cloud.k8sclustersync.v1.NetworkPolicyRule
	32,  // 15: illumio.cloud.k8sclustersync.v1.KubernetesNetworkPolicyData.egress_rules:type_name -> illumio.cloud.k8sclustersync.v1.NetworkPolicyRule
	26,  // 16: illumio.cloud.k8sclustersync.v1.KubernetesCiliumNetworkPolicyData.endpoint_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	14,  // 17: illumio.cloud.k8sclustersync.v1.KubernetesCiliumNetworkPolicyData.ingress_rules:type_name -> illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	14,  // 18: illumio.cloud.k8sclustersync.v1.KubernetesCiliumNetworkPolicyData.egress_rules:type_name -> illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	14,  // 19: illumio.cloud.k8sclustersync.v1.KubernetesCiliumNetworkPolicyData.ingress_deny_rules:type_name -> illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	14,  // 20: illumio.cloud.k8sclustersync.v1.KubernetesCiliumNetworkPolicyData.egress_deny_rules:type_name -> illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	26,  // 21: illumio.cloud.k8sclustersync.v1.KubernetesCiliumClusterwideNetworkPolicyData.endpoint_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	26,  // 22: illumio.cloud.k8sclustersync.v1.KubernetesCiliumClusterwideNetworkPolicyData.node_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	14,  // 23: illumio.cloud.k8sclustersync.v1.KubernetesCiliumClusterwideNetworkPolicyData.ingress_rules:type_name -> illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	14,  // 24: illumio.cloud.k8sclustersync.v1.KubernetesCiliumClusterwideNetworkPolicyData.egress_rules:type_name -> illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	14,  // 25: illumio.cloud.k8sclustersync.v1.KubernetesCiliumClusterwideNetworkPolicyData.ingress_deny_rules:type_name -> illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	14,  // 26: illumio.cloud.k8sclustersync.v1.KubernetesCiliumClusterwideNetworkPolicyData.egress_deny_rules:type_name -> illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	26,  // 27: illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule.from_endpoints:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	26,  // 28: illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule.to_endpoints:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	15,  // 29: illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule.from_cidr_set:type_name -> illumio.cloud.k8sclustersync.v1.CiliumCIDRSet
	15,  // 30: illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule.to_cidr_set:type_name -> illumio.cloud.k8sclustersync.v1.CiliumCIDRSet
	16,  // 31: illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule.to_ports:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPortRule
	17,  // 32: illumio.cloud.k8sclustersync.v1.CiliumPortRule.ports:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPort
	20,  // 33: illumio.cloud.k8sclustersync.v1.KubernetesAWSClusterNetworkPolicyData.subject:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicySubject
	22,  // 34: illumio.cloud.k8sclustersync.v1.KubernetesAWSClusterNetworkPolicyData.ingress_rules:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyRule
	22,  // 35: illumio.cloud.k8sclustersync.v1.KubernetesAWSClusterNetworkPolicyData.egress_rules:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyRule
	26,  // 36: illumio.cloud.k8sclustersync.v1.KubernetesAWSSecurityGroupPolicyData.pod_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	26,  // 37: illumio.cloud.k8sclustersync.v1.KubernetesAWSSecurityGroupPolicyData.service_account_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	21,  // 38: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicySubject.pods:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPodSelector
	26,  // 39: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicySubject.namespaces:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	26,  // 40: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPodSelector.namespace_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	26,  // 41: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPodSelector.pod_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	23,  // 42: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyRule.ports:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPort
	25,  // 43: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyRule.from:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPeer
	25,  // 44: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyRule.to:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPeer
	24,  // 45: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPort.port_number:type_name -> illumio.cloud.k8sclustersync.v1.AWSPortNumber
	21,  // 46: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPeer.pods:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPodSelector
	26,  // 47: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPeer.namespaces:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	63,  // 48: illumio.cloud.k8sclustersync.v1.LabelSelector.match_labels:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector.MatchLabelsEntry
	27,  // 49: illumio.cloud.k8sclustersync.v1.LabelSelector.match_expressions:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelectorRequirement
	28,  // 50: illumio.cloud.k8sclustersync.v1.Peer.ip_block:type_name -> illumio.cloud.k8sclustersync.v1.IPBlock
	30,  // 51: illumio.cloud.k8sclustersync.v1.Peer.pods:type_name -> illumio.cloud.k8sclustersync.v1.PeerSelector
	26,  // 52: illumio.cloud.k8sclustersync.v1.PeerSelector.namespace_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	26,  // 53: illumio.cloud.k8sclustersync.v1.PeerSelector.pod_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	5,   // 54: illumio.cloud.k8sclustersync.v1.Port.protocol:type_name -> illumio.cloud.k8sclustersync.v1.Port.Protocol
	29,  // 55: illumio.cloud.k8sclustersync.v1.NetworkPolicyRule.peers:type_name -> illumio.cloud.k8sclustersync.v1.Peer
	31,  // 56: illumio.cloud.k8sclustersync.v1.NetworkPolicyRule.ports:type_name -> illumio.cloud.k8sclustersync.v1.Port
	0,   // 57: illumio.cloud.k8sclustersync.v1.KubernetesClusterMetadata.flow_collector:type_name -> illumio.cloud.k8sclustersync.v1.FlowCollector
	6,   // 58: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest.keepalive:type_name -> illumio.cloud.k8sclustersync.v1.Keepalive
	34,  // 59: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest.cluster_metadata:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesClusterMetadata
	7,   // 60: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest.resource_data:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData
	36,  // 61: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest.resource_snapshot_complete:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesResourceSnapshotComplete
	38,  // 62: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest.kubernetes_resource_mutation:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesResourceMutation
	7,   // 63: illumio.cloud.k8sclustersync.v1.KubernetesResourceMutation.create_resource:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData
	7,   // 64: illumio.cloud.k8sclustersync.v1.KubernetesResourceMutation.update_resource:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData
	7,   // 65: illumio.cloud.k8sclustersync.v1.KubernetesResourceMutation.delete_resource:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData
	42,  // 66: illumio.cloud.k8sclustersync.v1.FiveTupleFlow.layer3:type_name -> illumio.cloud.k8sclustersync.v1.IP
	43,  // 67: illumio.cloud.k8sclustersync.v1.FiveTupleFlow.layer4:type_name -> illumio.cloud.k8sclustersync.v1.Layer4
	65,  // 68: illumio.cloud.k8sclustersync.v1.FiveTupleFlow.timestamp:type_name -> google.protobuf.Timestamp
	65,  // 69: illumio.cloud.k8sclustersync.v1.CiliumFlow.time:type_name -> google.protobuf.Timestamp
	1,   // 70: illumio.cloud.k8sclustersync.v1.CiliumFlow.traffic_direction:type_name -> illumio.cloud.k8sclustersync.v1.TrafficDirection
	2,   // 71: illumio.cloud.k8sclustersync.v1.CiliumFlow.verdict:type_name -> illumio.cloud.k8sclustersync.v1.Verdict
	42,  // 72: illumio.cloud.k8sclustersync.v1.CiliumFlow.layer3:type_name -> illumio.cloud.k8sclustersync.v1.IP
	43,  // 73: illumio.cloud.k8sclustersync.v1.CiliumFlow.layer4:type_name -> illumio.cloud.k8sclustersync.v1.Layer4
	66,  // 74: illumio.cloud.k8sclustersync.v1.CiliumFlow.is_reply:type_name -> google.protobuf.BoolValue
	50,  // 75: illumio.cloud.k8sclustersync.v1.CiliumFlow.source_endpoint:type_name -> illumio.cloud.k8sclustersync.v1.Endpoint
	50,  // 76: illumio.cloud.k8sclustersync.v1.CiliumFlow.destination_endpoint:type_name -> illumio.cloud.k8sclustersync.v1.Endpoint
	41,  // 77: illumio.cloud.k8sclustersync.v1.CiliumFlow.destination_service:type_name -> illumio.cloud.k8sclustersync.v1.Service
	52,  // 78: illumio.cloud.k8sclustersync.v1.CiliumFlow.egress_allowed_by:type_name -> illumio.cloud.k8sclustersync.v1.Policy
	52,  // 79: illumio.cloud.k8sclustersync.v1.CiliumFlow.ingress_allowed_by:type_name -> illumio.cloud.k8sclustersync.v1.Policy
	52,  // 80: illumio.cloud.k8sclustersync.v1.CiliumFlow.egress_denied_by:type_name -> illumio.cloud.k8sclustersync.v1.Policy
	52,  // 81: illumio.cloud.k8sclustersync.v1.CiliumFlow.ingress_denied_by:type_name -> illumio.cloud.k8sclustersync.v1.Policy
	3,   // 82: illumio.cloud.k8sclustersync.v1.IP.ip_version:type_name -> illumio.cloud.k8sclustersync.v1.IPVersion
	44,  // 83: illumio.cloud.k8sclustersync.v1.Layer4.tcp:type_name -> illumio.cloud.k8sclustersync.v1.TCP
	46,  // 84: illumio.cloud.k8sclustersync.v1.Layer4.udp:type_name -> illumio.cloud.k8sclustersync.v1.UDP
	48,  // 85: illumio.cloud.k8sclustersync.v1.Layer4.icmpv4:type_name -> illumio.cloud.k8sclustersync.v1.ICMPv4
	49,  // 86: illumio.cloud.k8sclustersync.v1.Layer4.icmpv6:type_name -> illumio.cloud.k8sclustersync.v1.ICMPv6
	47,  // 87: illumio.cloud.k8sclustersync.v1.Layer4.sctp:type_name -> illumio.cloud.k8sclustersync.v1.SCTP
	45,  // 88: illumio.cloud.k8sclustersync.v1.TCP.flags:type_name -> illumio.cloud.k8sclustersync.v1.TCPFlags
	51,  // 89: illumio.cloud.k8sclustersync.v1.Endpoint.workloads:type_name -> illumio.cloud.k8sclustersync.v1.Workload
	6,   // 90: illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsRequest.keepalive:type_name -> illumio.cloud.k8sclustersync.v1.Keepalive
	40,  // 91: illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsRequest.cilium_flow:type_name -> illumio.cloud.k8sclustersync.v1.CiliumFlow
	39,  // 92: illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsRequest.five_tuple_flow:type_name -> illumio.cloud.k8sclustersync.v1.FiveTupleFlow
	6,   // 93: illumio.cloud.k8sclustersync.v1.SendLogsRequest.keepalive:type_name -> illumio.cloud.k8sclustersync.v1.Keepalive
	55,  // 94: illumio.cloud.k8sclustersync.v1.SendLogsRequest.log_entry:type_name -> illumio.cloud.k8sclustersync.v1.LogEntry
	6,   // 95: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesRequest.keepalive:type_name -> illumio.cloud.k8sclustersync.v1.Keepalive
	64,  // 96: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse.update_configuration:type_name -> illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse.Configuration
	4,   // 97: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse.Configuration.log_level:type_name -> illumio.cloud.k8sclustersync.v1.LogLevel
	35,  // 98: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendKubernetesResources:input_type -> illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest
	53,  // 99: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendKubernetesNetworkFlows:input_type -> illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsRequest
	56,  // 100: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendLogs:input_type -> illumio.cloud.k8sclustersync.v1.SendLogsRequest
	58,  // 101: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.GetConfigurationUpdates:input_type -> illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesRequest
	37,  // 102: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendKubernetesResources:output_type -> illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesResponse
	54,  // 103: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendKubernetesNetworkFlows:output_type -> illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsResponse
	57,  // 104: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendLogs:output_type -> illumio.cloud.k8sclustersync.v1.SendLogsResponse
	59,  // 105: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.GetConfigurationUpdates:output_type -> illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse
...
func file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_init() {
	...
	file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_msgTypes[1].OneofWrappers = []any{
		...
		(*KubernetesObjectData_AwsSecurityGroupPolicy)(nil),
	}
