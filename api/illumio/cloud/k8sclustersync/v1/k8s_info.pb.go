...
// Network policy data for snapshot or create/update operations.
type NetworkPolicyData struct {
	...
	//
	//	*NetworkPolicyData_NamespacedPolicy
	//	*NetworkPolicyData_ClusterPolicy
	Scope         isNetworkPolicyData_Scope `protobuf_oneof:"scope"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NetworkPolicyData) GetScope() isNetworkPolicyData_Scope {
	if x != nil {
		return x.Scope
	}
	return nil
...
func (x *NetworkPolicyData) GetNamespacedPolicy() *NamespacedPolicyData {
	if x != nil {
		if x, ok := x.Scope.(*NetworkPolicyData_NamespacedPolicy); ok {
...
func (x *NetworkPolicyData) GetClusterPolicy() *ClusterPolicyData {
	if x != nil {
		if x, ok := x.Scope.(*NetworkPolicyData_ClusterPolicy); ok {
...
type isNetworkPolicyData_Scope interface {
	isNetworkPolicyData_Scope()
}

type NetworkPolicyData_NamespacedPolicy struct {
	NamespacedPolicy *NamespacedPolicyData `protobuf:"bytes,5,opt,name=namespaced_policy,json=namespacedPolicy,proto3,oneof"`
}

type NetworkPolicyData_ClusterPolicy struct {
	ClusterPolicy *ClusterPolicyData `protobuf:"bytes,6,opt,name=cluster_policy,json=clusterPolicy,proto3,oneof"`
}

func (*NetworkPolicyData_NamespacedPolicy) isNetworkPolicyData_Scope() {}

func (*NetworkPolicyData_ClusterPolicy) isNetworkPolicyData_Scope() {}
...
type DeleteNetworkPolicy struct {
	...
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// Policy scope - namespaced or cluster-wide.
	// The inner policy is empty; only the type matters for delete.
	//
	// Types that are valid to be assigned to Scope:
	//
	//	*DeleteNetworkPolicy_NamespacedPolicy
	//	*DeleteNetworkPolicy_ClusterPolicy
	Scope         isDeleteNetworkPolicy_Scope `protobuf_oneof:"scope"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DeleteNetworkPolicy) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *DeleteNetworkPolicy) GetScope() isDeleteNetworkPolicy_Scope {
	if x != nil {
		return x.Scope
	}
	return nil
...
func (x *DeleteNetworkPolicy) GetNamespacedPolicy() *NamespacedPolicyData {
	if x != nil {
		if x, ok := x.Scope.(*DeleteNetworkPolicy_NamespacedPolicy); ok {
			return x.NamespacedPolicy
		}
	}
	return nil
...
func (x *DeleteNetworkPolicy) GetClusterPolicy() *ClusterPolicyData {
	if x != nil {
		if x, ok := x.Scope.(*DeleteNetworkPolicy_ClusterPolicy); ok {
			return x.ClusterPolicy
		}
	}
	return nil
...
type isDeleteNetworkPolicy_Scope interface {
	isDeleteNetworkPolicy_Scope()
}

type DeleteNetworkPolicy_NamespacedPolicy struct {
	NamespacedPolicy *NamespacedPolicyData `protobuf:"bytes,3,opt,name=namespaced_policy,json=namespacedPolicy,proto3,oneof"`
}

type DeleteNetworkPolicy_ClusterPolicy struct {
	ClusterPolicy *ClusterPolicyData `protobuf:"bytes,4,opt,name=cluster_policy,json=clusterPolicy,proto3,oneof"`
}

func (*DeleteNetworkPolicy_NamespacedPolicy) isDeleteNetworkPolicy_Scope() {}

func (*DeleteNetworkPolicy_ClusterPolicy) isDeleteNetworkPolicy_Scope() {}
...
const file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_rawDesc = "" +
	...
	"\x06labels\x18\x03 \x03(\v2>.illumio.cloud.k8sclustersync.v1.NetworkPolicyData.LabelsEntryR\x06labels\x12e\n" +
	"\vannotations\x18\x04 \x03(\v2C.illumio.cloud.k8sclustersync.v1.NetworkPolicyData.AnnotationsEntryR\vannotations\x12d\n" +
	...
	"\x11namespaced_policy\x18\x03 \x01(\v25.illumio.cloud.k8sclustersync.v1.NamespacedPolicyDataH\x00R\x10namespacedPolicy\x12[\n" +
	"\x0ecluster_policy\x18\x04 \x01(\v22.illumio.cloud.k8sclustersync.v1.ClusterPolicyDataH\x00R\rclusterPolicyB\a\n" +
	"\x05scope\"\x1f\n" +
	"\x1dNetworkPolicySnapshotComplete\"\xb6\x02\n" +
	...
	"\rupdate_policy\x18\x02 \x01(\v22.illumio.cloud.k8sclustersync.v1.NetworkPolicyDataH\x00R\fupdatePolicy\x12[\n" +
...
var file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_goTypes = []any{
	...
	nil,                           // 76: illumio.cloud.k8sclustersync.v1.NetworkPolicyData.LabelsEntry
	nil,                           // 77: illumio.cloud.k8sclustersync.v1.NetworkPolicyData.AnnotationsEntry
...
var file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_depIdxs = []int32{
	...
	76,  // 98: illumio.cloud.k8sclustersync.v1.NetworkPolicyData.labels:type_name -> illumio.cloud.k8sclustersync.v1.NetworkPolicyData.LabelsEntry
	77,  // 99: illumio.cloud.k8sclustersync.v1.NetworkPolicyData.annotations:type_name -> illumio.cloud.k8sclustersync.v1.NetworkPolicyData.AnnotationsEntry
	64,  // 100: illumio.cloud.k8sclustersync.v1.NetworkPolicyData.namespaced_policy:type_name -> illumio.cloud.k8sclustersync.v1.NamespacedPolicyData
	65,  // 101: illumio.cloud.k8sclustersync.v1.NetworkPolicyData.cluster_policy:type_name -> illumio.cloud.k8sclustersync.v1.ClusterPolicyData
	...
	64,  // 105: illumio.cloud.k8sclustersync.v1.DeleteNetworkPolicy.namespaced_policy:type_name -> illumio.cloud.k8sclustersync.v1.NamespacedPolicyData
	65,  // 106: illumio.cloud.k8sclustersync.v1.DeleteNetworkPolicy.cluster_policy:type_name -> illumio.cloud.k8sclustersync.v1.ClusterPolicyData
	63,  // 107: illumio.cloud.k8sclustersync.v1.NetworkPolicyMutation.create_policy:type_name -> illumio.cloud.k8sclustersync.v1.NetworkPolicyData
	63,  // 108: illumio.cloud.k8sclustersync.v1.NetworkPolicyMutation.update_policy:type_name -> illumio.cloud.k8sclustersync.v1.NetworkPolicyData
	66,  // 109: illumio.cloud.k8sclustersync.v1.NetworkPolicyMutation.delete_policy:type_name -> illumio.cloud.k8sclustersync.v1.DeleteNetworkPolicy
	5,   // 110: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse.Configuration.log_level:type_name -> illumio.cloud.k8sclustersync.v1.LogLevel
	38,  // 111: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendKubernetesResources:input_type -> illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest
	56,  // 112: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendKubernetesNetworkFlows:input_type -> illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsRequest
	59,  // 113: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendLogs:input_type -> illumio.cloud.k8sclustersync.v1.SendLogsRequest
	61,  // 114: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.GetConfigurationUpdates:input_type -> illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesRequest
	40,  // 115: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendKubernetesResources:output_type -> illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesResponse
	57,  // 116: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendKubernetesNetworkFlows:output_type -> illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsResponse
	60,  // 117: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendLogs:output_type -> illumio.cloud.k8sclustersync.v1.SendLogsResponse
	62,  // 118: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.GetConfigurationUpdates:output_type -> illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse
...
func file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_init() {
	...
	file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_msgTypes[56].OneofWrappers = []any{
		(*NetworkPolicyData_NamespacedPolicy)(nil),
		(*NetworkPolicyData_ClusterPolicy)(nil),
	}
	...
	file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_msgTypes[59].OneofWrappers = []any{
		(*DeleteNetworkPolicy_NamespacedPolicy)(nil),
		(*DeleteNetworkPolicy_ClusterPolicy)(nil),
	}
