...
func (Port_Protocol) EnumDescriptor() ([]byte, []int) {
	return file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_rawDescGZIP(), []int{17, 0}
}
...
var file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_goTypes = []any{
	...
	(*LabelSelector)(nil),                                // 18: illumio.cloud.k8sclustersync.v1.LabelSelector
	(*LabelSelectorRequirement)(nil),                     // 19: illumio.cloud.k8sclustersync.v1.LabelSelectorRequirement
	(*IPBlock)(nil),                                      // 20: illumio.cloud.k8sclustersync.v1.IPBlock
	(*Peer)(nil),                                         // 21: illumio.cloud.k8sclustersync.v1.Peer
	(*PeerSelector)(nil),                                 // 22: illumio.cloud.k8sclustersync.v1.PeerSelector
	(*Port)(nil),                                         // 23: illumio.cloud.k8sclustersync.v1.Port
	(*NetworkPolicyRule)(nil),                            // 24: illumio.cloud.k8sclustersync.v1.NetworkPolicyRule
	(*KubernetesOwnerReference)(nil),                     // 25: illumio.cloud.k8sclustersync.v1.KubernetesOwnerReference
	(*KubernetesClusterMetadata)(nil),                    // 26: illumio.cloud.k8sclustersync.v1.KubernetesClusterMetadata
	(*SendKubernetesResourcesRequest)(nil),               // 27: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest
	(*KubernetesResourceSnapshotComplete)(nil),           // 28: illumio.cloud.k8sclustersync.v1.KubernetesResourceSnapshotComplete
	(*SendKubernetesResourcesResponse)(nil),              // 29: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesResponse
	(*KubernetesResourceMutation)(nil),                   // 30: illumio.cloud.k8sclustersync.v1.KubernetesResourceMutation
	(*FiveTupleFlow)(nil),                                // 31: illumio.cloud.k8sclustersync.v1.FiveTupleFlow
	(*CiliumFlow)(nil),                                   // 32: illumio.cloud.k8sclustersync.v1.CiliumFlow
	(*Service)(nil),                                      // 33: illumio.cloud.k8sclustersync.v1.Service
	(*IP)(nil),                                           // 34: illumio.cloud.k8sclustersync.v1.IP
	(*Layer4)(nil),                                       // 35: illumio.cloud.k8sclustersync.v1.Layer4
	(*TCP)(nil),                                          // 36: illumio.cloud.k8sclustersync.v1.TCP
	(*TCPFlags)(nil),                                     // 37: illumio.cloud.k8sclustersync.v1.TCPFlags
	(*UDP)(nil),                                          // 38: illumio.cloud.k8sclustersync.v1.UDP
	(*SCTP)(nil),                                         // 39: illumio.cloud.k8sclustersync.v1.SCTP
	(*ICMPv4)(nil),                                       // 40: illumio.cloud.k8sclustersync.v1.ICMPv4
	(*ICMPv6)(nil),                                       // 41: illumio.cloud.k8sclustersync.v1.ICMPv6
	(*Endpoint)(nil),                                     // 42: illumio.cloud.k8sclustersync.v1.Endpoint
	(*Workload)(nil),                                     // 43: illumio.cloud.k8sclustersync.v1.Workload
	(*Policy)(nil),                                       // 44: illumio.cloud.k8sclustersync.v1.Policy
	(*SendKubernetesNetworkFlowsRequest)(nil),            // 45: illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsRequest
	(*SendKubernetesNetworkFlowsResponse)(nil),           // 46: illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsResponse
	(*LogEntry)(nil),                                     // 47: illumio.cloud.k8sclustersync.v1.LogEntry
	(*SendLogsRequest)(nil),                              // 48: illumio.cloud.k8sclustersync.v1.SendLogsRequest
	(*SendLogsResponse)(nil),                             // 49: illumio.cloud.k8sclustersync.v1.SendLogsResponse
	(*GetConfigurationUpdatesRequest)(nil),               // 50: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesRequest
	(*GetConfigurationUpdatesResponse)(nil),              // 51: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse
	nil,                                                  // 52: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.AnnotationsEntry
	nil,                                                  // 53: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.LabelsEntry
	(*KubernetesServiceData_ServicePort)(nil),            // 54: illumio.cloud.k8sclustersync.v1.KubernetesServiceData.ServicePort
	nil, // 55: illumio.cloud.k8sclustersync.v1.LabelSelector.MatchLabelsEntry
	(*GetConfigurationUpdatesResponse_Configuration)(nil), // 56: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse.Configuration
...
var file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_depIdxs = []int32{
	52, // 0: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.annotations:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData.AnnotationsEntry
	57, // 1: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.creation_timestamp:type_name -> google.protobuf.Timestamp
	53, // 2: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.labels:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData.LabelsEntry
	25, // 3: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.owner_references:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesOwnerReference
	...
	54, // 10: illumio.cloud.k8sclustersync.v1.KubernetesServiceData.ports:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesServiceData.ServicePort
	18, // 11: illumio.cloud.k8sclustersync.v1.KubernetesNetworkPolicyData.pod_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	24, // 12: illumio.cloud.k8sclustersync.v1.KubernetesNetworkPolicyData.ingress_rules:type_name -> illumio.cloud.k8sclustersync.v1.NetworkPolicyRule
	24, // 13: illumio.cloud.k8sclustersync.v1.KubernetesNetworkPolicyData.egress_rules:type_name -> illumio.cloud.k8sclustersync.v1.NetworkPolicyRule
	18, // 14: illumio.cloud.k8sclustersync.v1.KubernetesCiliumNetworkPolicyData.endpoint_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	14, // 15: illumio.cloud.k8sclustersync.v1.KubernetesCiliumNetworkPolicyData.ingress_rules:type_name -> illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	14, // 16: illumio.cloud.k8sclustersync.v1.KubernetesCiliumNetworkPolicyData.egress_rules:type_name -> illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	14, // 17: illumio.cloud.k8sclustersync.v1.KubernetesCiliumNetworkPolicyData.ingress_deny_rules:type_name -> illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	14, // 18: illumio.cloud.k8sclustersync.v1.KubernetesCiliumNetworkPolicyData.egress_deny_rules:type_name -> illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	18, // 19: illumio.cloud.k8sclustersync.v1.KubernetesCiliumClusterwideNetworkPolicyData.endpoint_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	18, // 20: illumio.cloud.k8sclustersync.v1.KubernetesCiliumClusterwideNetworkPolicyData.node_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	14, // 21: illumio.cloud.k8sclustersync.v1.KubernetesCiliumClusterwideNetworkPolicyData.ingress_rules:type_name -> illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	14, // 22: illumio.cloud.k8sclustersync.v1.KubernetesCiliumClusterwideNetworkPolicyData.egress_rules:type_name -> illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	14, // 23: illumio.cloud.k8sclustersync.v1.KubernetesCiliumClusterwideNetworkPolicyData.ingress_deny_rules:type_name -> illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	14, // 24: illumio.cloud.k8sclustersync.v1.KubernetesCiliumClusterwideNetworkPolicyData.egress_deny_rules:type_name -> illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule
	18, // 25: illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule.from_endpoints:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	18, // 26: illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule.to_endpoints:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	15, // 27: illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule.from_cidr_set:type_name -> illumio.cloud.k8sclustersync.v1.CiliumCIDRSet
	15, // 28: illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule.to_cidr_set:type_name -> illumio.cloud.k8sclustersync.v1.CiliumCIDRSet
	16, // 29: illumio.cloud.k8sclustersync.v1.CiliumNetworkPolicyRule.to_ports:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPortRule
	17, // 30: illumio.cloud.k8sclustersync.v1.CiliumPortRule.ports:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPort
	55, // 31: illumio.cloud.k8sclustersync.v1.LabelSelector.match_labels:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector.MatchLabelsEntry
	19, // 32: illumio.cloud.k8sclustersync.v1.LabelSelector.match_expressions:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelectorRequirement
	20, // 33: illumio.cloud.k8sclustersync.v1.Peer.ip_block:type_name -> illumio.cloud.k8sclustersync.v1.IPBlock
	22, // 34: illumio.cloud.k8sclustersync.v1.Peer.pods:type_name -> illumio.cloud.k8sclustersync.v1.PeerSelector
	18, // 35: illumio.cloud.k8sclustersync.v1.PeerSelector.namespace_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	18, // 36: illumio.cloud.k8sclustersync.v1.PeerSelector.pod_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	5,  // 37: illumio.cloud.k8sclustersync.v1.Port.protocol:type_name -> illumio.cloud.k8sclustersync.v1.Port.Protocol
	21, // 38: illumio.cloud.k8sclustersync.v1.NetworkPolicyRule.peers:type_name -> illumio.cloud.k8sclustersync.v1.Peer
	23, // 39: illumio.cloud.k8sclustersync.v1.NetworkPolicyRule.ports:type_name -> illumio.cloud.k8sclustersync.v1.Port
	0,  // 40: illumio.cloud.k8sclustersync.v1.KubernetesClusterMetadata.flow_collector:type_name -> illumio.cloud.k8sclustersync.v1.FlowCollector
	6,  // 41: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest.keepalive:type_name -> illumio.cloud.k8sclustersync.v1.Keepalive
	26, // 42: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest.cluster_metadata:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesClusterMetadata
	7,  // 43: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest.resource_data:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData
	28, // 44: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest.resource_snapshot_complete:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesResourceSnapshotComplete
	30, // 45: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest.kubernetes_resource_mutation:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesResourceMutation
	7,  // 46: illumio.cloud.k8sclustersync.v1.KubernetesResourceMutation.create_resource:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData
	7,  // 47: illumio.cloud.k8sclustersync.v1.KubernetesResourceMutation.update_resource:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData
	7,  // 48: illumio.cloud.k8sclustersync.v1.KubernetesResourceMutation.delete_resource:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData
	34, // 49: illumio.cloud.k8sclustersync.v1.FiveTupleFlow.layer3:type_name -> illumio.cloud.k8sclustersync.v1.IP
	35, // 50: illumio.cloud.k8sclustersync.v1.FiveTupleFlow.layer4:type_name -> illumio.cloud.k8sclustersync.v1.Layer4
	57, // 51: illumio.cloud.k8sclustersync.v1.FiveTupleFlow.timestamp:type_name -> google.protobuf.Timestamp
	57, // 52: illumio.cloud.k8sclustersync.v1.CiliumFlow.time:type_name -> google.protobuf.Timestamp
	1,  // 53: illumio.cloud.k8sclustersync.v1.CiliumFlow.traffic_direction:type_name -> illumio.cloud.k8sclustersync.v1.TrafficDirection
	2,  // 54: illumio.cloud.k8sclustersync.v1.CiliumFlow.verdict:type_name -> illumio.cloud.k8sclustersync.v1.Verdict
	34, // 55: illumio.cloud.k8sclustersync.v1.CiliumFlow.layer3:type_name -> illumio.cloud.k8sclustersync.v1.IP
	35, // 56: illumio.cloud.k8sclustersync.v1.CiliumFlow.layer4:type_name -> illumio.cloud.k8sclustersync.v1.Layer4
	58, // 57: illumio.cloud.k8sclustersync.v1.CiliumFlow.is_reply:type_name -> google.protobuf.BoolValue
	42, // 58: illumio.cloud.k8sclustersync.v1.CiliumFlow.source_endpoint:type_name -> illumio.cloud.k8sclustersync.v1.Endpoint
	42, // 59: illumio.cloud.k8sclustersync.v1.CiliumFlow.destination_endpoint:type_name -> illumio.cloud.k8sclustersync.v1.Endpoint
	33, // 60: illumio.cloud.k8sclustersync.v1.CiliumFlow.destination_service:type_name -> illumio.cloud.k8sclustersync.v1.Service
	44, // 61: illumio.cloud.k8sclustersync.v1.CiliumFlow.egress_allowed_by:type_name -> illumio.cloud.k8sclustersync.v1.Policy
	44, // 62: illumio.cloud.k8sclustersync.v1.CiliumFlow.ingress_allowed_by:type_name -> illumio.cloud.k8sclustersync.v1.Policy
	44, // 63: illumio.cloud.k8sclustersync.v1.CiliumFlow.egress_denied_by:type_name -> illumio.cloud.k8sclustersync.v1.Policy
	44, // 64: illumio.cloud.k8sclustersync.v1.CiliumFlow.ingress_denied_by:type_name -> illumio.cloud.k8sclustersync.v1.Policy
	3,  // 65: illumio.cloud.k8sclustersync.v1.IP.ip_version:type_name -> illumio.cloud.k8sclustersync.v1.IPVersion
	36, // 66: illumio.cloud.k8sclustersync.v1.Layer4.tcp:type_name -> illumio.cloud.k8sclustersync.v1.TCP
	38, // 67: illumio.cloud.k8sclustersync.v1.Layer4.udp:type_name -> illumio.cloud.k8sclustersync.v1.UDP
	40, // 68: illumio.cloud.k8sclustersync.v1.Layer4.icmpv4:type_name -> illumio.cloud.k8sclustersync.v1.ICMPv4
	41, // 69: illumio.cloud.k8sclustersync.v1.Layer4.icmpv6:type_name -> illumio.cloud.k8sclustersync.v1.ICMPv6
	39, // 70: illumio.cloud.k8sclustersync.v1.Layer4.sctp:type_name -> illumio.cloud.k8sclustersync.v1.SCTP
	37, // 71: illumio.cloud.k8sclustersync.v1.TCP.flags:type_name -> illumio.cloud.k8sclustersync.v1.TCPFlags
	43, // 72: illumio.cloud.k8sclustersync.v1.Endpoint.workloads:type_name -> illumio.cloud.k8sclustersync.v1.Workload
	6,  // 73: illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsRequest.keepalive:type_name -> illumio.cloud.k8sclustersync.v1.Keepalive
	32, // 74: illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsRequest.cilium_flow:type_name -> illumio.cloud.k8sclustersync.v1.CiliumFlow
	31, // 75: illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsRequest.five_tuple_flow:type_name -> illumio.cloud.k8sclustersync.v1.FiveTupleFlow
	6,  // 76: illumio.cloud.k8sclustersync.v1.SendLogsRequest.keepalive:type_name -> illumio.cloud.k8sclustersync.v1.Keepalive
	47, // 77: illumio.cloud.k8sclustersync.v1.SendLogsRequest.log_entry:type_name -> illumio.cloud.k8sclustersync.v1.LogEntry
	6,  // 78: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesRequest.keepalive:type_name -> illumio.cloud.k8sclustersync.v1.Keepalive
	56, // 79: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse.update_configuration:type_name -> illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse.Configuration
	4,  // 80: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse.Configuration.log_level:type_name -> illumio.cloud.k8sclustersync.v1.LogLevel
	27, // 81: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendKubernetesResources:input_type -> illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest
	45, // 82: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendKubernetesNetworkFlows:input_type -> illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsRequest
	48, // 83: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendLogs:input_type -> illumio.cloud.k8sclustersync.v1.SendLogsRequest
	50, // 84: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.GetConfigurationUpdates:input_type -> illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesRequest
	29, // 85: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendKubernetesResources:output_type -> illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesResponse
	46, // 86: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendKubernetesNetworkFlows:output_type -> illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsResponse
	49, // 87: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendLogs:output_type -> illumio.cloud.k8sclustersync.v1.SendLogsResponse
	51, // 88: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.GetConfigurationUpdates:output_type -> illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse
