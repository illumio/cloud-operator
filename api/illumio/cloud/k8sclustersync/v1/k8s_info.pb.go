...
func (*GetConfigurationUpdatesResponse_Configuration) Descriptor() ([]byte, []int) {
	return file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_rawDescGZIP(), []int{87, 0}
}
...
const file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_rawDesc = "" +
	...
	"\x1dbaseline_admin_network_policy\x18o \x01(\v2I.illumio.cloud.k8sclustersync.v1.KubernetesBaselineAdminNetworkPolicyDataH\x00R\x1abaselineAdminNetworkPolicy\x1a>\n" +
	...
	"\x03end\x18\x03 \x01(\x05R\x03end\"\xa2\a\n" +
...
var file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_msgTypes = make([]protoimpl.MessageInfo, 104)
var file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_goTypes = []any{
	...
	(*CiliumPolicyRule)(nil),                             // 26: illumio.cloud.k8sclustersync.v1.CiliumPolicyRule
	(*CiliumPolicyDefaultDeny)(nil),                      // 27: illumio.cloud.k8sclustersync.v1.CiliumPolicyDefaultDeny
	(*CiliumPolicyIngressRule)(nil),                      // 28: illumio.cloud.k8sclustersync.v1.CiliumPolicyIngressRule
	(*CiliumPolicyEgressRule)(nil),                       // 29: illumio.cloud.k8sclustersync.v1.CiliumPolicyEgressRule
	(*CiliumPolicyCIDRSet)(nil),                          // 30: illumio.cloud.k8sclustersync.v1.CiliumPolicyCIDRSet
	(*CiliumPolicyGroup)(nil),                            // 31: illumio.cloud.k8sclustersync.v1.CiliumPolicyGroup
	(*CiliumPolicyAWSGroup)(nil),                         // 32: illumio.cloud.k8sclustersync.v1.CiliumPolicyAWSGroup
	(*CiliumPolicyICMPRule)(nil),                         // 33: illumio.cloud.k8sclustersync.v1.CiliumPolicyICMPRule
	(*CiliumPolicyICMPField)(nil),                        // 34: illumio.cloud.k8sclustersync.v1.CiliumPolicyICMPField
	(*CiliumPolicyAuthentication)(nil),                   // 35: illumio.cloud.k8sclustersync.v1.CiliumPolicyAuthentication
	(*CiliumPolicyFQDNSelector)(nil),                     // 36: illumio.cloud.k8sclustersync.v1.CiliumPolicyFQDNSelector
	(*CiliumPolicyService)(nil),                          // 37: illumio.cloud.k8sclustersync.v1.CiliumPolicyService
	(*CiliumPolicyK8SServiceSelector)(nil),               // 38: illumio.cloud.k8sclustersync.v1.CiliumPolicyK8sServiceSelector
	(*CiliumPolicyK8SService)(nil),                       // 39: illumio.cloud.k8sclustersync.v1.CiliumPolicyK8sService
	(*CiliumPolicyPortRule)(nil),                         // 40: illumio.cloud.k8sclustersync.v1.CiliumPolicyPortRule
	(*CiliumPolicyPort)(nil),                             // 41: illumio.cloud.k8sclustersync.v1.CiliumPolicyPort
	(*KubernetesAWSClusterNetworkPolicyData)(nil),        // 42: illumio.cloud.k8sclustersync.v1.KubernetesAWSClusterNetworkPolicyData
	(*AWSNetworkPolicySubject)(nil),                      // 43: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicySubject
	(*AWSNetworkPolicyPodSelector)(nil),                  // 44: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPodSelector
	(*AWSNetworkPolicyIngressRule)(nil),                  // 45: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyIngressRule
	(*AWSNetworkPolicyEgressRule)(nil),                   // 46: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyEgressRule
	(*AWSNetworkPolicyPort)(nil),                         // 47: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPort
	(*AWSNetworkPolicyPortNumber)(nil),                   // 48: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPortNumber
	(*AWSNetworkPolicyPortRange)(nil),                    // 49: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPortRange
	(*AWSNetworkPolicyIngressPeer)(nil),                  // 50: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyIngressPeer
	(*AWSNetworkPolicyEgressPeer)(nil),                   // 51: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyEgressPeer
	(*KubernetesAWSApplicationNetworkPolicyData)(nil),    // 52: illumio.cloud.k8sclustersync.v1.KubernetesAWSApplicationNetworkPolicyData
	(*AWSApplicationNetworkPolicyIngressRule)(nil),       // 53: illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyIngressRule
	(*AWSApplicationNetworkPolicyEgressRule)(nil),        // 54: illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyEgressRule
	(*AWSApplicationNetworkPolicyIngressPeer)(nil),       // 55: illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyIngressPeer
	(*AWSApplicationNetworkPolicyEgressPeer)(nil),        // 56: illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyEgressPeer
	(*AWSApplicationNetworkPolicyPort)(nil),              // 57: illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyPort
	(*LabelSelector)(nil),                                // 58: illumio.cloud.k8sclustersync.v1.LabelSelector
	(*LabelSelectorList)(nil),                            // 59: illumio.cloud.k8sclustersync.v1.LabelSelectorList
	(*LabelSelectorRequirement)(nil),                     // 60: illumio.cloud.k8sclustersync.v1.LabelSelectorRequirement
	(*IPBlock)(nil),                                      // 61: illumio.cloud.k8sclustersync.v1.IPBlock
	(*Peer)(nil),                                         // 62: illumio.cloud.k8sclustersync.v1.Peer
	(*PeerSelector)(nil),                                 // 63: illumio.cloud.k8sclustersync.v1.PeerSelector
	(*Port)(nil),                                         // 64: illumio.cloud.k8sclustersync.v1.Port
	(*NetworkPolicyRule)(nil),                            // 65: illumio.cloud.k8sclustersync.v1.NetworkPolicyRule
	(*KubernetesOwnerReference)(nil),                     // 66: illumio.cloud.k8sclustersync.v1.KubernetesOwnerReference
	(*GkeClusterIdentity)(nil),                           // 67: illumio.cloud.k8sclustersync.v1.GkeClusterIdentity
	(*KubernetesClusterMetadata)(nil),                    // 68: illumio.cloud.k8sclustersync.v1.KubernetesClusterMetadata
	(*SendKubernetesResourcesRequest)(nil),               // 69: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest
	(*KubernetesResourceSnapshotComplete)(nil),           // 70: illumio.cloud.k8sclustersync.v1.KubernetesResourceSnapshotComplete
	(*SendKubernetesResourcesResponse)(nil),              // 71: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesResponse
	(*KubernetesResourceMutation)(nil),                   // 72: illumio.cloud.k8sclustersync.v1.KubernetesResourceMutation
	(*FiveTupleFlow)(nil),                                // 73: illumio.cloud.k8sclustersync.v1.FiveTupleFlow
	(*CiliumFlow)(nil),                                   // 74: illumio.cloud.k8sclustersync.v1.CiliumFlow
	(*Service)(nil),                                      // 75: illumio.cloud.k8sclustersync.v1.Service
	(*IP)(nil),                                           // 76: illumio.cloud.k8sclustersync.v1.IP
	(*Layer4)(nil),                                       // 77: illumio.cloud.k8sclustersync.v1.Layer4
	(*TCP)(nil),                                          // 78: illumio.cloud.k8sclustersync.v1.TCP
	(*TCPFlags)(nil),                                     // 79: illumio.cloud.k8sclustersync.v1.TCPFlags
	(*UDP)(nil),                                          // 80: illumio.cloud.k8sclustersync.v1.UDP
	(*SCTP)(nil),                                         // 81: illumio.cloud.k8sclustersync.v1.SCTP
	(*ICMPv4)(nil),                                       // 82: illumio.cloud.k8sclustersync.v1.ICMPv4
	(*ICMPv6)(nil),                                       // 83: illumio.cloud.k8sclustersync.v1.ICMPv6
	(*Endpoint)(nil),                                     // 84: illumio.cloud.k8sclustersync.v1.Endpoint
	(*Workload)(nil),                                     // 85: illumio.cloud.k8sclustersync.v1.Workload
	(*Policy)(nil),                                       // 86: illumio.cloud.k8sclustersync.v1.Policy
	(*SendKubernetesNetworkFlowsRequest)(nil),            // 87: illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsRequest
	(*SendKubernetesNetworkFlowsResponse)(nil),           // 88: illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsResponse
	(*LogEntry)(nil),                                     // 89: illumio.cloud.k8sclustersync.v1.LogEntry
	(*SendLogsRequest)(nil),                              // 90: illumio.cloud.k8sclustersync.v1.SendLogsRequest
	(*SendLogsResponse)(nil),                             // 91: illumio.cloud.k8sclustersync.v1.SendLogsResponse
	(*GetConfigurationUpdatesRequest)(nil),               // 92: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesRequest
	(*GetConfigurationUpdatesResponse)(nil),              // 93: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse
	(*ConfiguredKubernetesObjectData)(nil),               // 94: illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectData
	(*DeleteConfiguredKubernetesObject)(nil),             // 95: illumio.cloud.k8sclustersync.v1.DeleteConfiguredKubernetesObject
	(*ConfiguredKubernetesObjectSnapshotComplete)(nil),   // 96: illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectSnapshotComplete
	(*ConfiguredKubernetesObjectMutation)(nil),           // 97: illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectMutation
	nil, // 98: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.AnnotationsEntry
	nil, // 99: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.LabelsEntry
	nil, // 100: illumio.cloud.k8sclustersync.v1.KubernetesServiceData.SelectorEntry
	(*KubernetesServiceData_ServicePort)(nil), // 101: illumio.cloud.k8sclustersync.v1.KubernetesServiceData.ServicePort
	nil, // 102: illumio.cloud.k8sclustersync.v1.KubernetesWorkloadData.TemplateLabelsEntry
	nil, // 103: illumio.cloud.k8sclustersync.v1.KubernetesWorkloadData.SelectorMatchLabelsEntry
	nil, // 104: illumio.cloud.k8sclustersync.v1.CiliumPolicyRule.LabelsEntry
	nil, // 105: illumio.cloud.k8sclustersync.v1.CiliumPolicyAWSGroup.LabelsEntry
	nil, // 106: illumio.cloud.k8sclustersync.v1.LabelSelector.MatchLabelsEntry
	(*GetConfigurationUpdatesResponse_Configuration)(nil), // 107: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse.Configuration
	nil,                           // 108: illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectData.AnnotationsEntry
	nil,                           // 109: illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectData.LabelsEntry
...
var file_illumio_cloud_k8sclustersync_v1_k8s_info_proto_depIdxs = []int32{
	98,  // 0: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.annotations:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData.AnnotationsEntry
	110, // 1: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.creation_timestamp:type_name -> google.protobuf.Timestamp
	99,  // 2: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.labels:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData.LabelsEntry
	66,  // 3: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.owner_references:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesOwnerReference
	...
	42,  // 12: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.aws_cluster_network_policy:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesAWSClusterNetworkPolicyData
	52,  // 13: illumio.cloud.k8sclustersync.v1.KubernetesObjectData.aws_application_network_policy:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesAWSApplicationNetworkPolicyData
	...
	101, // 16: illumio.cloud.k8sclustersync.v1.KubernetesServiceData.ports:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesServiceData.ServicePort
	100, // 17: illumio.cloud.k8sclustersync.v1.KubernetesServiceData.selector:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesServiceData.SelectorEntry
	102, // 18: illumio.cloud.k8sclustersync.v1.KubernetesWorkloadData.template_labels:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesWorkloadData.TemplateLabelsEntry
	103, // 19: illumio.cloud.k8sclustersync.v1.KubernetesWorkloadData.selector_match_labels:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesWorkloadData.SelectorMatchLabelsEntry
	58,  // 20: illumio.cloud.k8sclustersync.v1.KubernetesNetworkPolicyData.pod_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	65,  // 21: illumio.cloud.k8sclustersync.v1.KubernetesNetworkPolicyData.ingress_rules:type_name -> illumio.cloud.k8sclustersync.v1.NetworkPolicyRule
	65,  // 22: illumio.cloud.k8sclustersync.v1.KubernetesNetworkPolicyData.egress_rules:type_name -> illumio.cloud.k8sclustersync.v1.NetworkPolicyRule
	26,  // 23: illumio.cloud.k8sclustersync.v1.KubernetesCiliumNetworkPolicyData.specs:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyRule
	26,  // 24: illumio.cloud.k8sclustersync.v1.KubernetesCiliumClusterwideNetworkPolicyData.specs:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyRule
	16,  // 25: illumio.cloud.k8sclustersync.v1.KubernetesCiliumCIDRGroupData.spec:type_name -> illumio.cloud.k8sclustersync.v1.CiliumCIDRGroup
	19,  // 26: illumio.cloud.k8sclustersync.v1.KubernetesAdminNetworkPolicyData.subject:type_name -> illumio.cloud.k8sclustersync.v1.AdminNetworkPolicySubject
	21,  // 27: illumio.cloud.k8sclustersync.v1.KubernetesAdminNetworkPolicyData.ingress:type_name -> illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyRule
	21,  // 28: illumio.cloud.k8sclustersync.v1.KubernetesAdminNetworkPolicyData.egress:type_name -> illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyRule
	19,  // 29: illumio.cloud.k8sclustersync.v1.KubernetesBaselineAdminNetworkPolicyData.subject:type_name -> illumio.cloud.k8sclustersync.v1.AdminNetworkPolicySubject
	21,  // 30: illumio.cloud.k8sclustersync.v1.KubernetesBaselineAdminNetworkPolicyData.ingress:type_name -> illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyRule
	21,  // 31: illumio.cloud.k8sclustersync.v1.KubernetesBaselineAdminNetworkPolicyData.egress:type_name -> illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyRule
	58,  // 32: illumio.cloud.k8sclustersync.v1.AdminNetworkPolicySubject.namespaces:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	20,  // 33: illumio.cloud.k8sclustersync.v1.AdminNetworkPolicySubject.pods:type_name -> illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyNamespacedPod
	58,  // 34: illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyNamespacedPod.namespace_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	58,  // 35: illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyNamespacedPod.pod_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	22,  // 36: illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyRule.peers:type_name -> illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyPeer
	23,  // 37: illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyRule.ports:type_name -> illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyPort
	58,  // 38: illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyPeer.namespaces:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	20,  // 39: illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyPeer.pods:type_name -> illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyNamespacedPod
	58,  // 40: illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyPeer.nodes:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	24,  // 41: illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyPort.port_number:type_name -> illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyPortNumber
	25,  // 42: illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyPort.port_range:type_name -> illumio.cloud.k8sclustersync.v1.AdminNetworkPolicyPortRange
	58,  // 43: illumio.cloud.k8sclustersync.v1.CiliumPolicyRule.endpoint_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	58,  // 44: illumio.cloud.k8sclustersync.v1.CiliumPolicyRule.node_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	104, // 45: illumio.cloud.k8sclustersync.v1.CiliumPolicyRule.labels:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyRule.LabelsEntry
	27,  // 46: illumio.cloud.k8sclustersync.v1.CiliumPolicyRule.enable_default_deny:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyDefaultDeny
	28,  // 47: illumio.cloud.k8sclustersync.v1.CiliumPolicyRule.ingress:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyIngressRule
	29,  // 48: illumio.cloud.k8sclustersync.v1.CiliumPolicyRule.egress:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyEgressRule
	28,  // 49: illumio.cloud.k8sclustersync.v1.CiliumPolicyRule.ingress_deny:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyIngressRule
	29,  // 50: illumio.cloud.k8sclustersync.v1.CiliumPolicyRule.egress_deny:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyEgressRule
	59,  // 51: illumio.cloud.k8sclustersync.v1.CiliumPolicyIngressRule.from_endpoints:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelectorList
	30,  // 52: illumio.cloud.k8sclustersync.v1.CiliumPolicyIngressRule.from_cidr_set:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyCIDRSet
	31,  // 53: illumio.cloud.k8sclustersync.v1.CiliumPolicyIngressRule.from_groups:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyGroup
	58,  // 54: illumio.cloud.k8sclustersync.v1.CiliumPolicyIngressRule.from_nodes:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	40,  // 55: illumio.cloud.k8sclustersync.v1.CiliumPolicyIngressRule.to_ports:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyPortRule
	33,  // 56: illumio.cloud.k8sclustersync.v1.CiliumPolicyIngressRule.icmps:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyICMPRule
	35,  // 57: illumio.cloud.k8sclustersync.v1.CiliumPolicyIngressRule.authentication:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyAuthentication
	59,  // 58: illumio.cloud.k8sclustersync.v1.CiliumPolicyEgressRule.to_endpoints:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelectorList
	30,  // 59: illumio.cloud.k8sclustersync.v1.CiliumPolicyEgressRule.to_cidr_set:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyCIDRSet
	36,  // 60: illumio.cloud.k8sclustersync.v1.CiliumPolicyEgressRule.to_fqdns:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyFQDNSelector
	37,  // 61: illumio.cloud.k8sclustersync.v1.CiliumPolicyEgressRule.to_services:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyService
	31,  // 62: illumio.cloud.k8sclustersync.v1.CiliumPolicyEgressRule.to_groups:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyGroup
	58,  // 63: illumio.cloud.k8sclustersync.v1.CiliumPolicyEgressRule.to_nodes:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	40,  // 64: illumio.cloud.k8sclustersync.v1.CiliumPolicyEgressRule.to_ports:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyPortRule
	33,  // 65: illumio.cloud.k8sclustersync.v1.CiliumPolicyEgressRule.icmps:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyICMPRule
	35,  // 66: illumio.cloud.k8sclustersync.v1.CiliumPolicyEgressRule.authentication:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyAuthentication
	58,  // 67: illumio.cloud.k8sclustersync.v1.CiliumPolicyCIDRSet.cidr_group_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	32,  // 68: illumio.cloud.k8sclustersync.v1.CiliumPolicyGroup.aws:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyAWSGroup
	105, // 69: illumio.cloud.k8sclustersync.v1.CiliumPolicyAWSGroup.labels:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyAWSGroup.LabelsEntry
	34,  // 70: illumio.cloud.k8sclustersync.v1.CiliumPolicyICMPRule.fields:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyICMPField
	38,  // 71: illumio.cloud.k8sclustersync.v1.CiliumPolicyService.k8s_service_selector:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyK8sServiceSelector
	39,  // 72: illumio.cloud.k8sclustersync.v1.CiliumPolicyService.k8s_service:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyK8sService
	58,  // 73: illumio.cloud.k8sclustersync.v1.CiliumPolicyK8sServiceSelector.selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	41,  // 74: illumio.cloud.k8sclustersync.v1.CiliumPolicyPortRule.ports:type_name -> illumio.cloud.k8sclustersync.v1.CiliumPolicyPort
	43,  // 75: illumio.cloud.k8sclustersync.v1.KubernetesAWSClusterNetworkPolicyData.subject:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicySubject
	45,  // 76: illumio.cloud.k8sclustersync.v1.KubernetesAWSClusterNetworkPolicyData.ingress:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyIngressRule
	46,  // 77: illumio.cloud.k8sclustersync.v1.KubernetesAWSClusterNetworkPolicyData.egress:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyEgressRule
	44,  // 78: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicySubject.pods:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPodSelector
	58,  // 79: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicySubject.namespaces:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	58,  // 80: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPodSelector.namespace_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	58,  // 81: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPodSelector.pod_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	47,  // 82: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyIngressRule.ports:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPort
	50,  // 83: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyIngressRule.from:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyIngressPeer
	47,  // 84: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyEgressRule.ports:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPort
	51,  // 85: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyEgressRule.to:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyEgressPeer
	48,  // 86: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPort.port_number:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPortNumber
	49,  // 87: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPort.port_range:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPortRange
	44,  // 88: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyIngressPeer.pods:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPodSelector
	58,  // 89: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyIngressPeer.namespaces:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	44,  // 90: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyEgressPeer.pods:type_name -> illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyPodSelector
	58,  // 91: illumio.cloud.k8sclustersync.v1.AWSNetworkPolicyEgressPeer.namespaces:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	58,  // 92: illumio.cloud.k8sclustersync.v1.KubernetesAWSApplicationNetworkPolicyData.pod_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	53,  // 93: illumio.cloud.k8sclustersync.v1.KubernetesAWSApplicationNetworkPolicyData.ingress:type_name -> illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyIngressRule
	54,  // 94: illumio.cloud.k8sclustersync.v1.KubernetesAWSApplicationNetworkPolicyData.egress:type_name -> illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyEgressRule
	55,  // 95: illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyIngressRule.from:type_name -> illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyIngressPeer
	57,  // 96: illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyIngressRule.ports:type_name -> illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyPort
	56,  // 97: illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyEgressRule.to:type_name -> illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyEgressPeer
	57,  // 98: illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyEgressRule.ports:type_name -> illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyPort
	58,  // 99: illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyIngressPeer.pod_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	58,  // 100: illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyIngressPeer.namespace_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	61,  // 101: illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyIngressPeer.ip_block:type_name -> illumio.cloud.k8sclustersync.v1.IPBlock
	58,  // 102: illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyEgressPeer.pod_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	58,  // 103: illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyEgressPeer.namespace_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	61,  // 104: illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyEgressPeer.ip_block:type_name -> illumio.cloud.k8sclustersync.v1.IPBlock
	111, // 105: illumio.cloud.k8sclustersync.v1.AWSApplicationNetworkPolicyPort.port:type_name -> google.protobuf.Value
	106, // 106: illumio.cloud.k8sclustersync.v1.LabelSelector.match_labels:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector.MatchLabelsEntry
	60,  // 107: illumio.cloud.k8sclustersync.v1.LabelSelector.match_expressions:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelectorRequirement
	58,  // 108: illumio.cloud.k8sclustersync.v1.LabelSelectorList.items:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	61,  // 109: illumio.cloud.k8sclustersync.v1.Peer.ip_block:type_name -> illumio.cloud.k8sclustersync.v1.IPBlock
	63,  // 110: illumio.cloud.k8sclustersync.v1.Peer.pods:type_name -> illumio.cloud.k8sclustersync.v1.PeerSelector
	58,  // 111: illumio.cloud.k8sclustersync.v1.PeerSelector.namespace_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	58,  // 112: illumio.cloud.k8sclustersync.v1.PeerSelector.pod_selector:type_name -> illumio.cloud.k8sclustersync.v1.LabelSelector
	5,   // 113: illumio.cloud.k8sclustersync.v1.Port.protocol:type_name -> illumio.cloud.k8sclustersync.v1.Port.Protocol
	62,  // 114: illumio.cloud.k8sclustersync.v1.NetworkPolicyRule.peers:type_name -> illumio.cloud.k8sclustersync.v1.Peer
	64,  // 115: illumio.cloud.k8sclustersync.v1.NetworkPolicyRule.ports:type_name -> illumio.cloud.k8sclustersync.v1.Port
	0,   // 116: illumio.cloud.k8sclustersync.v1.KubernetesClusterMetadata.flow_collector:type_name -> illumio.cloud.k8sclustersync.v1.FlowCollector
	67,  // 117: illumio.cloud.k8sclustersync.v1.KubernetesClusterMetadata.gke_identity:type_name -> illumio.cloud.k8sclustersync.v1.GkeClusterIdentity
	6,   // 118: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest.keepalive:type_name -> illumio.cloud.k8sclustersync.v1.Keepalive
	68,  // 119: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest.cluster_metadata:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesClusterMetadata
	7,   // 120: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest.resource_data:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData
	70,  // 121: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest.resource_snapshot_complete:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesResourceSnapshotComplete
	72,  // 122: illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest.kubernetes_resource_mutation:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesResourceMutation
	7,   // 123: illumio.cloud.k8sclustersync.v1.KubernetesResourceMutation.create_resource:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData
	7,   // 124: illumio.cloud.k8sclustersync.v1.KubernetesResourceMutation.update_resource:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData
	7,   // 125: illumio.cloud.k8sclustersync.v1.KubernetesResourceMutation.delete_resource:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesObjectData
	76,  // 126: illumio.cloud.k8sclustersync.v1.FiveTupleFlow.layer3:type_name -> illumio.cloud.k8sclustersync.v1.IP
	77,  // 127: illumio.cloud.k8sclustersync.v1.FiveTupleFlow.layer4:type_name -> illumio.cloud.k8sclustersync.v1.Layer4
	110, // 128: illumio.cloud.k8sclustersync.v1.FiveTupleFlow.timestamp:type_name -> google.protobuf.Timestamp
	110, // 129: illumio.cloud.k8sclustersync.v1.CiliumFlow.time:type_name -> google.protobuf.Timestamp
	1,   // 130: illumio.cloud.k8sclustersync.v1.CiliumFlow.traffic_direction:type_name -> illumio.cloud.k8sclustersync.v1.TrafficDirection
	2,   // 131: illumio.cloud.k8sclustersync.v1.CiliumFlow.verdict:type_name -> illumio.cloud.k8sclustersync.v1.Verdict
	76,  // 132: illumio.cloud.k8sclustersync.v1.CiliumFlow.layer3:type_name -> illumio.cloud.k8sclustersync.v1.IP
	77,  // 133: illumio.cloud.k8sclustersync.v1.CiliumFlow.layer4:type_name -> illumio.cloud.k8sclustersync.v1.Layer4
	112, // 134: illumio.cloud.k8sclustersync.v1.CiliumFlow.is_reply:type_name -> google.protobuf.BoolValue
	84,  // 135: illumio.cloud.k8sclustersync.v1.CiliumFlow.source_endpoint:type_name -> illumio.cloud.k8sclustersync.v1.Endpoint
	84,  // 136: illumio.cloud.k8sclustersync.v1.CiliumFlow.destination_endpoint:type_name -> illumio.cloud.k8sclustersync.v1.Endpoint
	75,  // 137: illumio.cloud.k8sclustersync.v1.CiliumFlow.destination_service:type_name -> illumio.cloud.k8sclustersync.v1.Service
	86,  // 138: illumio.cloud.k8sclustersync.v1.CiliumFlow.egress_allowed_by:type_name -> illumio.cloud.k8sclustersync.v1.Policy
	86,  // 139: illumio.cloud.k8sclustersync.v1.CiliumFlow.ingress_allowed_by:type_name -> illumio.cloud.k8sclustersync.v1.Policy
	86,  // 140: illumio.cloud.k8sclustersync.v1.CiliumFlow.egress_denied_by:type_name -> illumio.cloud.k8sclustersync.v1.Policy
	86,  // 141: illumio.cloud.k8sclustersync.v1.CiliumFlow.ingress_denied_by:type_name -> illumio.cloud.k8sclustersync.v1.Policy
	3,   // 142: illumio.cloud.k8sclustersync.v1.IP.ip_version:type_name -> illumio.cloud.k8sclustersync.v1.IPVersion
	78,  // 143: illumio.cloud.k8sclustersync.v1.Layer4.tcp:type_name -> illumio.cloud.k8sclustersync.v1.TCP
	80,  // 144: illumio.cloud.k8sclustersync.v1.Layer4.udp:type_name -> illumio.cloud.k8sclustersync.v1.UDP
	82,  // 145: illumio.cloud.k8sclustersync.v1.Layer4.icmpv4:type_name -> illumio.cloud.k8sclustersync.v1.ICMPv4
	83,  // 146: illumio.cloud.k8sclustersync.v1.Layer4.icmpv6:type_name -> illumio.cloud.k8sclustersync.v1.ICMPv6
	81,  // 147: illumio.cloud.k8sclustersync.v1.Layer4.sctp:type_name -> illumio.cloud.k8sclustersync.v1.SCTP
	79,  // 148: illumio.cloud.k8sclustersync.v1.TCP.flags:type_name -> illumio.cloud.k8sclustersync.v1.TCPFlags
	85,  // 149: illumio.cloud.k8sclustersync.v1.Endpoint.workloads:type_name -> illumio.cloud.k8sclustersync.v1.Workload
	6,   // 150: illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsRequest.keepalive:type_name -> illumio.cloud.k8sclustersync.v1.Keepalive
	74,  // 151: illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsRequest.cilium_flow:type_name -> illumio.cloud.k8sclustersync.v1.CiliumFlow
	73,  // 152: illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsRequest.five_tuple_flow:type_name -> illumio.cloud.k8sclustersync.v1.FiveTupleFlow
	6,   // 153: illumio.cloud.k8sclustersync.v1.SendLogsRequest.keepalive:type_name -> illumio.cloud.k8sclustersync.v1.Keepalive
	89,  // 154: illumio.cloud.k8sclustersync.v1.SendLogsRequest.log_entry:type_name -> illumio.cloud.k8sclustersync.v1.LogEntry
	6,   // 155: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesRequest.keepalive:type_name -> illumio.cloud.k8sclustersync.v1.Keepalive
	107, // 156: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse.update_configuration:type_name -> illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse.Configuration
	94,  // 157: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse.resource_data:type_name -> illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectData
	96,  // 158: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse.resource_snapshot_complete:type_name -> illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectSnapshotComplete
	97,  // 159: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse.resource_mutation:type_name -> illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectMutation
	108, // 160: illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectData.annotations:type_name -> illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectData.AnnotationsEntry
	109, // 161: illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectData.labels:type_name -> illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectData.LabelsEntry
	13,  // 162: illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectData.cilium_network_policy:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesCiliumNetworkPolicyData
	14,  // 163: illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectData.cilium_clusterwide_network_policy:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesCiliumClusterwideNetworkPolicyData
	15,  // 164: illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectData.cilium_cidr_group:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesCiliumCIDRGroupData
	42,  // 165: illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectData.aws_cluster_network_policy:type_name -> illumio.cloud.k8sclustersync.v1.KubernetesAWSClusterNetworkPolicyData
	94,  // 166: illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectMutation.create_or_update_object:type_name -> illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectData
	95,  // 167: illumio.cloud.k8sclustersync.v1.ConfiguredKubernetesObjectMutation.delete_object:type_name -> illumio.cloud.k8sclustersync.v1.DeleteConfiguredKubernetesObject
	4,   // 168: illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse.Configuration.log_level:type_name -> illumio.cloud.k8sclustersync.v1.LogLevel
	69,  // 169: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendKubernetesResources:input_type -> illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesRequest
	87,  // 170: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendKubernetesNetworkFlows:input_type -> illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsRequest
	90,  // 171: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendLogs:input_type -> illumio.cloud.k8sclustersync.v1.SendLogsRequest
	92,  // 172: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.GetConfigurationUpdates:input_type -> illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesRequest
	71,  // 173: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendKubernetesResources:output_type -> illumio.cloud.k8sclustersync.v1.SendKubernetesResourcesResponse
	88,  // 174: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendKubernetesNetworkFlows:output_type -> illumio.cloud.k8sclustersync.v1.SendKubernetesNetworkFlowsResponse
	91,  // 175: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.SendLogs:output_type -> illumio.cloud.k8sclustersync.v1.SendLogsResponse
	93,  // 176: illumio.cloud.k8sclustersync.v1.KubernetesInfoService.GetConfigurationUpdates:output_type -> illumio.cloud.k8sclustersync.v1.GetConfigurationUpdatesResponse
	173, // [173:177] is the sub-list for method output_type
	169, // [169:173] is the sub-list for method input_type
