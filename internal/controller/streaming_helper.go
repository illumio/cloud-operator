...
func sendCiliumFlow(sm *streamManager, flow *pb.CiliumFlow) error {
	if err := sm.instance.ciliumNetworkFlowsStream.Send(&pb.SendKubernetesNetworkFlowsRequest{Request: &pb.SendKubernetesNetworkFlowsRequest_CiliumFlow{CiliumFlow: flow}}); err != nil {
