...
func sendObjectMetadata(sm *streamManager, data *pb.KubernetesObjectMetadata) error {
...
func streamMutationObjectMetadata(sm *streamManager, data *pb.KubernetesObjectMetadata, eventType watch.EventType) error {
	switch eventType {
	case watch.Added:
